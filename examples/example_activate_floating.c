...
main()
{
  ...
  license_key = cryptolens_activate_floating(&e, cryptolens, "WyIxMzE0NyIsIko5dFpiYVlvbDBUUmtFekp2MTVVTkFKN2dnSGFqTnBwRlE3NERzU1oiXQ==", "5454", "BXCMU-QRXBK-VSADS-BALIV", "600", NULL);
